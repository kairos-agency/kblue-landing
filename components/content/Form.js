                    ...
                    >
                        <div id='mc_embed_signup_scroll'>
                            <div className='mc-field-group'>
                                <label htmlFor='mce-EMAIL'>{content.email}</label>
                                <input type='email' name='EMAIL' className='required email' id='mce-EMAIL' required='' />
                            </div>
                            <div className='mc-field-group'>
                                <label htmlFor='mce-LNAME'>{content.name}</label>
                            ...
                            <div aria-hidden='true' style={{ display: 'none' }}>
                                <input type='text' name='b_cdbe50ac410ba94aa4ca0b2f9_f8b1ee1ee4' tabIndex='-1' defaultValue='' />
                            </div>
                            <div>
                                <input
                                    type='submit'
