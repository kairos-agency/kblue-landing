...
function SpinningBoxWebGL({ scale, scrollState, ...props }) {
    ...
    return (
        <group ref={group} {...props} dispose={null} scale={100}>
            <group name="Scene">
                <mesh name="Window01" castShadow receiveShadow geometry={nodes.Window01.geometry} position={[-8.018, 3.022, -1.224]} rotation={[0, 0, 0.32]}>
                    <meshPhysicalMaterial color={'#3F65FC'} />
                </mesh>
                <mesh name="Window02" castShadow receiveShadow geometry={nodes.Window02.geometry} position={[-6.715, 2.953, -1.503]} rotation={[0, 0, 0.124]}>
                    <meshPhysicalMaterial color={'#2854ff'} />
                </mesh>
                <mesh name="Window03" castShadow receiveShadow geometry={nodes.Window03.geometry} position={[-8.075, -3.184, 0.774]} rotation={[0, 0, -0.408]}>
                    <meshPhysicalMaterial color={'#3F65FC'} />
                </mesh>
                <mesh name="Window04" castShadow receiveShadow geometry={nodes.Window04.geometry} position={[7.324, 3.338, -1.031]} rotation={[0, 0, -0.38]}>
                    <meshPhysicalMaterial color={'#3F65FC'} />
                </mesh>

                <mesh name="Window05" castShadow receiveShadow geometry={nodes.Window05.geometry} position={[8.232, 0.494, -1.696]} rotation={[0, 0, -0.459]}>
